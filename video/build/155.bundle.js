"use strict";
(self["webpackChunkmotion_pages_video"] = self["webpackChunkmotion_pages_video"] || []).push([[155],{
    ...
    async fetchPacketForSampleIndex(sampleIndex, options) {
        ...
        if (options.metadataOnly) {
            ...
            if (this.internalTrack.encryptionAuxInfo) {
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.internalTrack.encryptionInfo);
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'vp9' && !this.internalTrack.info.vp9CodecInfo) {
                ...
                this.internalTrack.info.vp9CodecInfo = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractVp9CodecInfoFromPacket */ .bs)(firstPacket.data);
            }
            else if (this.internalTrack.info.codec === 'av1' && !this.internalTrack.info.av1CodecInfo) {
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.av1CodecInfo = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractAv1CodecInfoFromPacket */ .UU)(firstPacket.data);
            }
            const config = {
            ...
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.MatrixCoefficients:
                {
                    ...
                    const mapped = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .MATRIX_COEFFICIENTS_MAP_INVERSE */ .fl[matrixCoefficients] ?? null;
            ...
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Range:
                {
                    if (this.currentTrack?.info?.type !== 'video' || !this.currentTrack.info.colorSpace)
                        break;
                    this.currentTrack.info.colorSpace.fullRange = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size) === 2;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TransferCharacteristics:
                {
                    ...
                    const mapped = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */ .x_[transferCharacteristics] ?? null;
            ...
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Primaries:
                {
                    ...
                    const mapped = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .COLOR_PRIMARIES_MAP_INVERSE */ .BL[primaries] ?? null;
...
class MatroskaVideoTrackBacking extends MatroskaTrackBacking {
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            ...
            const config = {
                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractVideoCodecString */ .QP)({
...
const readNextMp3FrameHeader = async (reader, startPos, until, ref = null) => {
    ...
    while (until === null || currentPos < until) {
        ...
        while (slice.remainingLength >= _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .MP3_FRAME_HEADER_SIZE */ .D_) {
            ...
            const word = (0,_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .readU32Be */ .cN)(slice);
